...
var i = (e2, t2, r, i2, p3) => {
  ...
  if (!c[d2]) {
    ...
    c[d2] = o(p3 ? { ["@keyframes " + d2]: t3 } : t3, r ? "" : "." + d2);
  }
...
var p2 = (e2, t2, r) => e2.reduce((e3, l2, a2) => {
  let n3 = t2[a2];
  if (n3 && n3.call) {
...
function u(e2) {
  ...
  return i(l2.unshift ? l2.raw ? p2(l2, [].slice.call(arguments, 1), r.p) : l2.reduce((e3, t2) => Object.assign(e3, t2 && t2.call ? t2(r.p) : t2), {}) : l2, t(r.target), r.g, r.o, r.k);
}
var d;
var f;
var g2;
...
function j(e2, t2) {
  ...
  return function() {
    ...
    function a2(n3, o2) {
      ...
      let i2 = e2;
      return e2[0] && (i2 = c2.as || e2, delete c2.as), g2 && i2[0] && g2(c2), d(i2, c2);
    }
    return t2 ? t2(a2) : a2;
  };
}
...
var D = (e2) => {
  ...
  let s2 = x(() => {
    ...
    let { reverseOrder: i2 = false, gutter: d2 = 8, defaultPosition: p3 } = c2 || {}, g3 = t2.filter((m2) => (m2.position || p3) === (r.position || p3) && m2.height), E = g3.findIndex((m2) => m2.id === r.id), x2 = g3.filter((m2, R) => R < E && m2.visible).length;
    return g3.filter((m2) => m2.visible).slice(...i2 ? [x2 + 1] : [0, x2]).reduce((m2, R) => m2 + (R.height || 0) + d2, 0);
  }, [t2]);
...
var M = ({ toast: e2 }) => {
  ...
  return t2 !== void 0 ? typeof t2 == "string" ? y(fe, null, t2) : t2 : o2 === "blank" ? null : y(le, null, y(V, { ...s2 }), o2 !== "loading" && y(ue, null, o2 === "error" ? y(_2, { ...s2 }) : y(w2, { ...s2 })));
};
var ye = (e2) => `
...
var F = w(({ toast: e2, position: t2, style: o2, children: s2 }) => {
  let a2 = e2.height ? Ae(e2.position || t2 || "top-center", e2.visible) : { opacity: 0 }, r = y(M, { toast: e2 }), c2 = y(Se, { ...e2.ariaProps }, T(e2.message, e2));
  return y(be, { className: e2.className, style: { ...a2, ...o2, ...e2.style } }, typeof s2 == "function" ? s2({ icon: r, message: c2 }) : y(g, null, r, c2));
});
m(y);
var Ee = ({ id: e2, className: t2, style: o2, onHeightUpdate: s2, children: a2 }) => {
  ...
  return y("div", { ref: r, className: t2, style: o2 }, a2);
};
var Re = (e2, t2) => {
...
var Ie = ({ reverseOrder: e2, position: t2 = "top-center", toastOptions: o2, gutter: s2, children: a2, containerStyle: r, containerClassName: c2 }) => {
  ...
  return y("div", { style: { position: "fixed", zIndex: 9999, top: O, left: O, right: O, bottom: O, pointerEvents: "none", ...r }, className: c2, onMouseEnter: d2.startPause, onMouseLeave: d2.endPause }, i2.map((p3) => {
    let g3 = p3.position || t2, E = d2.calculateOffset(p3, { reverseOrder: e2, gutter: s2, defaultPosition: t2 }), x2 = Re(g3, E);
    return y(Ee, { id: p3.id, key: p3.id, onHeightUpdate: d2.updateHeight, className: p3.visible ? ve : "", style: x2 }, p3.type === "custom" ? T(p3.message, p3) : a2 ? a2(p3) : y(F, { toast: p3, position: g3 }));
  }));
};
var _t = n2;
export {
