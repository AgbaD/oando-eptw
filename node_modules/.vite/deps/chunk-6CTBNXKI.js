...
c(D.prototype = new b(), { shouldComponentUpdate: function(n) {
  ...
  var e, u, f = n.onChange, a2 = t.url, s2 = this.c, h2 = this.g($(n.children), a2);
  if (h2 && (u = B(h2[0], c(c({ url: a2, matches: e = h2[1] }, e), { key: void 0, ref: void 0 }))), a2 !== (s2 && s2.url)) {
...
//# sourceMappingURL=chunk-6CTBNXKI.js.map
