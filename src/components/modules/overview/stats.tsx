    ...
    <div className="app-overview__stats">
      ...
      <div className="app-overview__stats__wrapper">
        ...
        <div className="app-overview__stats__stat">
          ...
          <path d="M22.35 10H17.65C16.61 10 15.76 10.84 15.76 11.88V12.82C15.76 13.86 16.6 14.7 17.64 14.7H22.35C23.39 14.7 24.23 13.86 24.23 12.82V11.88C24.24 10.84 23.39 10 22.35 10Z" fill="#D30021"/>
          <path d="M25.24 12.82C25.24 14.41 23.94 15.71 22.35 15.71H17.65C16.06 15.71 14.76 14.41 14.76 12.82C14.76 12.26 14.16 11.91 13.66 12.17C12.25 12.92 11.29 14.41 11.29 16.12V25.53C11.29 27.99 13.3 30 15.76 30H24.24C26.7 30 28.71 27.99 28.71 25.53V16.12C28.71 14.41 27.75 12.92 26.34 12.17C25.84 11.91 25.24 12.26 25.24 12.82ZM22.53 24.69C22.38 24.84 22.19 24.91 22 24.91C21.81 24.91 21.62 24.84 21.47 24.69L20.02 23.24L18.53 24.73C18.38 24.88 18.19 24.95 18 24.95C17.81 24.95 17.62 24.88 17.47 24.73C17.18 24.44 17.18 23.96 17.47 23.67L18.96 22.18L17.51 20.73C17.22 20.44 17.22 19.96 17.51 19.67C17.8 19.38 18.28 19.38 18.57 19.67L20.02 21.12L21.42 19.72C21.71 19.43 22.19 19.43 22.48 19.72C22.77 20.01 22.77 20.49 22.48 20.78L21.08 22.18L22.53 23.63C22.82 23.92 22.82 24.39 22.53 24.69Z" fill="#D30021"/>
          </svg>
