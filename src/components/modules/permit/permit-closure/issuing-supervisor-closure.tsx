...
import IssuingClosureSubmit from "./modules/issuing-supervisor-closure-submit";
    ...
    <div className="app-create-permit app-register">
      ...
      <div className="app-register__content-wrapper app-container-wrapper ">
        <div className="app-register__content app-container">
          ...
          {state.matches("submit") && <IssuingClosureSubmit />}
        </div>
...
export default function ClosureIssuingSupervisor({}: any) {
  return (
    <RevalidationProvider>
      <Module />
    </RevalidationProvider>
