...
export default function SafetyOfficer({ permit }: any) {
  ...
  return (
    <div className="app-section">
      {permit.safetyOfficerStatus === "IN_PROGRESS" ? (
        ...
        <Accordion show title="Approval Details">
          ...
          <AccordionItem
            title="Date"
            value={dayjs(permit.safetyOfficerStatusDate).format(
              "MMM DD, YYYY HH:mm A"
            )}
          />
          <AccordionItem
      ...
      <Modal
        ...
        align="center"
      >
        <ModalHeader>Safety Officer</ModalHeader>
        <ModalBody>
          {/* prettier-ignore */}
