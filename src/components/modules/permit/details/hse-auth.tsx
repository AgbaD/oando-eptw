...
import { approveHseAuth, rejectHseAuth } from "../../../../assets/api/permit";
import { toast } from "../../../ui/toast";
import dayjs from "dayjs";

export default function HseAuth({ permit }: any) {
    ...
    <div className="app-section">
      {permit.hseAuthorityStatus === "IN_PROGRESS" ? (
        ...
        <Accordion show title="Approval Details">
          ...
          <AccordionItem
            title="Date"
            value={dayjs(permit.hseAuthorityStatusDate).format(
              "MMM DD, YYYY HH:mm A"
            )}
          />
      ...
      <Modal
        ...
        align="center"
      >
        <ModalHeader>HSE Auth</ModalHeader>
        <ModalBody>
          {/* prettier-ignore */}
