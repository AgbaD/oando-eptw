...
import { approveAuthorizingAuth, rejectAuthorizingAuth } from "../../../../assets/api/permit";
import { toast } from "../../../ui/toast";

export default function AuthorizingAuth({ permit }: any) {
  ...
  return (
    <div className="app-section">
      {permit.authorizingAuthorityStatus === "IN_PROGRESS" ? (
        ...
        <Accordion show title="Approval Details">
          ...
          <AccordionItem
            title="Date"
            value={dayjs(permit.authorizingAuthorityStatusDate).format(
              "MMM DD, YYYY HH:mm A"
            )}
          />
      ...
      <Modal
        ...
        align="center"
      >
        <ModalHeader>Authorizing Authority</ModalHeader>
        <ModalBody>
          {/* prettier-ignore */}
      ...
      >
        ...
        <ModalBody>
          ...
          <h4 className="app-modal__content__title">Reject Permit</h4>
          <p className="app-modal__content__desc">
            By rejecting this permit, it means you have verified all the details
            and document provided and they do not match the required standards.
          </p>
