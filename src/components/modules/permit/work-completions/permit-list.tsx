...
import { getPermitCompletions } from "../../../../assets/api/permit";
import useRequest from "../../../../hooks/use-request";

export default function PermitsList({ flag }: any) {
  const { response, isLoading } = useRequest(getPermitCompletions, { flag }, true);
